...
export class CAL {
  ...
  constructor(page: Page) {
    ...
    //super balance
    this.superbalance = page.locator(
      '[id="Retirement Calculator Super Balance"]'
    );
    //ownhome read element
    this.ownhome = page.locator(
      '[data-test="ownsHome"] [data-test="selected"]'
    );
    //select item
    this.selectitem = page.locator(
      '[data-test="ownsHome"] [data-test="items"] div'
    );
    //Next button
    ...
    //partner super
    this.partnerSuper = page.locator(
      '[id="Retirement Calculator Partner Super Balance"]'
    );
  }
